...
if (isset($_GET['delete'])){
  $sno = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `thought` WHERE `sno` = $sno";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  if (isset($_POST['snoEdit'])){
    //Update the record
    $sno = $_POST["snoEdit"];
    $title = $_POST["titleEdit"]; //getting the value using $_POST method
    $description =  $_POST["descEdit"];
    
    //Sql query to be executed
    $sql = "UPDATE `thought` SET `Thought` = '$title' , `description` = '$description' WHERE `thought`.`sno` = $sno";
    $result = mysqli_query($conn, $sql);
  if ($result) {
      $update = true;
  } else {
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editModalLabel">Edit this thought</h1>
      ...
      <input type= "hidden" name = "snoEdit" id = "snoEdit">
            ...
            <div class="mb-3">
                <label for="descEdit" class="form-label">Thought description</label>
...
if ($delete){
  echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
  <strong>Success!</strong> Your thought has been deleted successfully
  <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
</div>";
}
?>
...
if ($update){
  echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
  <strong>Success!</strong> Your thought has been updated successfully
  <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
</div>";
}
?>
